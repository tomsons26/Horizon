...
#define EXE_ENTRY 0x004D9C94 // C&C real entry point

// Define the EXE to launch and the DLL to inject.
#define EXE_NAME "c&c95.exe" // C&C actual binary (English 1.04 version supported).
#define DLL_NAME "horizon.dll" // Our reimplementation DLL.
