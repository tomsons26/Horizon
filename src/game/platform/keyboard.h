...
private:
    ...
    BOOL Put_Key_Message(uint16_t keycode, BOOL release = false, BOOL double_click = false);
    void Put_Mouse_Message(uint16_t keycode, int mouse_x, int mouse_y, BOOL release = false, BOOL double_click = false);
