...
TimerClass::TimerClass(TimerClass const &that) :
    m_started(that.m_started), m_accumulated(that.m_accumulated), m_tickType(that.m_tickType)
{
}
...
CountDownTimerClass::CountDownTimerClass(BaseTimerEnum timer, int set, BOOL on) : TimerClass(timer, on)
{
    //
    //
    //
